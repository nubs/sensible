...
class PagerStrategyTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getFromEnvironmentVariable()
    {
        ...
        $strategy = new PagerStrategy(['a', 'b', 'c'], $this->_commandLocator, $this->_environment);
    ...
    {
        $this->_environment->expects($this->once())->method('getenv')->with('PAGER')->will($this->returnValue(false));
