...
/**
 * @coversDefaultClass \Nubs\Sensible\Strategy\BrowserStrategy
 */
class BrowserStrategyTest extends PHPUnit_Framework_TestCase
{
    ...
    public function get()
    {
        ...
        $strategy = new BrowserStrategy(['a', 'b', 'c'], $this->_commandLocator);
